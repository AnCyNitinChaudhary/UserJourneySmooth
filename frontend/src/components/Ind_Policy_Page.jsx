                ...
                <div className='bg-white w-11/12 h-[315vh] rounded-[2rem] flex items-center flex-col'>
                    <div className='bg-[#0072BC] h-auto w-5/6 rounded-[2rem] mt-[3.5rem] flex'>
                        <div className='flex flex-col px-16 py-12'>
                            ...
                            <div className='mt-1 text-[#f89c30] text-[1.3rem] font-semibold'>CareerConnect</div>
                            <div className='pl-5'>
                                <ul className='mt-2 list-disc text-[1.3rem] text-white'>
                                    <li>Guaranteed mature job benefit and guaranteed additional benefits</li>
                                    <li>Future Proof Job</li>
                                    <li>Ride benefits to enhance coverage</li>
                                    <li>Multiple premium payment </li>
                                </ul>
                            </div>
                            <div className='grid grid-cols-2 mt-5'>
                                ...
                                <div className='flex flex-col'>
                                    <div className='text-[1.5rem] underline font-bold text-[#f89c30]'>Download jOB TERMS Document</div>
                                    <div className='text-white'>9499 KB</div>
                                </div>
                            </div>
                    ...
                    <div className='flex flex-col justify-start w-full px-[9.5rem]'>
                        <div className='text-[2.4rem] font-semibold'> <span className='text-[#f89c30]'>Documents you'll need</span> <span className='text-gray-400'>Before Applying</span></div>
