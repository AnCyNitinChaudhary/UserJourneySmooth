...
// formData.name !== "" && phone !== "" && formData.dob != "" && email != "" && pincode !== "" && formData.address !== "" && education !== ""
            if(true){
                const policyData = {      
                    fullname,
                    phone,
                  ...
                  // console.log(policyData.fullname)
            }
            ...
            <div className='flex justify-center items-center w-full h-[auto] p-10'>
                <div className='bg-white h-auto rounded-[1rem] flex flex-col w-5/6'>                               
                    <div className='flex flex-col items-center'>
                        <div className='font-bold text-[3.7rem] mt-10 text-primary'>Application Form</div>
